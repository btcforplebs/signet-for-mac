...
export { EventService, getEventService, setEventService, emitCurrentStats, type ServerEvent, type EventCallback, type DeadManSwitchStatus } from './event-service.js';
